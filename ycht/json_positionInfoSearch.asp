...
positionKeyWord=request("positionKeyWord")

Response.Charset="utf-8"
set json = new jsonclass
if positionKeyWord="" then
	json.sql="select * from positions"
else
	json.sql = "select * from positions where positionName like '%"+positionKeyWord+"%'"
end if
