	...
	$("#datepicker").datepicker({
		...
		onSelect: function(dateText,inst){
		  //  alert("您选择的日期是："+dateText)
			...
			url="http://www.gtwhp.com/ps/lbs/gps_points.asp?start=0\&limit=2000\&username="+username+"\&timeup="+dateText
		    window.open (url,'newwindow','height=100%,width=100%,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no') 
			//alert("您选择的日期是："+dateText)
		}
	});
